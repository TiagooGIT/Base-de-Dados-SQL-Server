...
select @jobId
GO
EXEC msdb.dbo.sp_add_jobserver @job_name=N'Backups_diff', @server_name = N'BD2'
GO
USE [msdb]
GO
EXEC msdb.dbo.sp_add_jobstep @job_name=N'Backups_diff', @step_name=N'backups_diff', 
		...
		@command=N'BACKUP DATABASE [ProjetoBD2] TO  DISK = N''E:\Backups\ProjetoBD2_diff.bak'' 
WITH  DIFFERENTIAL , NOFORMAT, NOINIT,  NAME = N''ProjetoBD2-diff Database Backup'', SKIP, NOREWIND, NOUNLOAD,  STATS = 10, CHECKSUM
GO

BACKUP DATABASE [ProjetoBD2] TO  DISK = N''R:\Backups\ProjetoBD2_diff.bak'' 
WITH  DIFFERENTIAL , NOFORMAT, NOINIT,  NAME = N''ProjetoBD2-diff Database Backup'', SKIP, NOREWIND, NOUNLOAD,  STATS = 10, CHECKSUM
GO', 
